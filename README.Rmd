...
gi=na.omit(gi)
dim(gi)
write.csv(gr, "data\\graduation_rate.csv", row.names=FALSE)
write.csv(gi, "data\\graudation_intension.csv", row.names=FALSE)
```
...
write.csv(df, "data\\dropout.csv", row.names=FALSE)
```
